...
public:
    ...
    G4VPhysicalVolume *ConstructCDEX300System_LG();
    G4VPhysicalVolume *ConstructCDEX300System_LF();
    ...
    G4bool GetFiberTPBStatus() const
    {
        return ifFiberTPB;
    }
    G4ThreeVector GetWirePos() const
    {
        return fWirePos;
    }
    ...
    G4double GetWireLength() const
    {
        return fWireLength;
    }

    G4String GetWireType() const
    {
        return fWireType;
    }

    G4String GetConfine() const
    {
        return fConfine;
    }

    G4String GetRunInfo() const
    {
        return fRunInfo;
    }

    G4String GetReflectorType() const
    {
        return fReflectorType;
    }

    G4int GetPENPropertiesID() const
    {
        return fPENPropertiesID;
    }

    G4int GetUnitNumber() const
    {
        return fUnitNb;
    }

    G4double GetPENShellLength() const
    {
        return fPENShellLength;
    }

    G4double GetPENShellRadius() const
    {
        return fPENShellRadius;
    }

    G4double GetSArBrickRadius() const
    {
        return fSArBrickRadius;
    }

    G4double GetSArBrickHeight() const
    {
        return fSArBrickHeight;
    }
    G4double GetASICThickness() const
    {
        return fASICThickness;
    }

    G4double GetBucketOuterRadius() const
    {
        return fBucketRadius;
    }
    G4double GetBucketThickness() const
    {
        return fBucketThickness;
    }
    G4double GetBucketHeight() const
    {
        return fBucketHeight;
    }

    G4double GetContainerOuterRadius() const
    {
    ...
    G4double GetSmallestUnitHeight() const
    {
        return fSmallestUnitHeight;
    }

    G4double GetFiberRadius() const
    {
        return fFiberRadius;
    }
    G4double GetFiberTPBThickness() const
    {
        return fFiberTPBThickness;
    }
    G4double GetFiberPlacementRadius() const
    {
        return fFiberPlacementRadius;
    }
    G4ThreeVector GetFiberPlacementCenter() const
    {
        return fFiberPlacementCenter;
    }

    G4double GetCuShieldThickness() const
    {
    ...
    G4double GetArYieldRatio() const
    {
        return fArYieldRatio;
    }
    G4double GetArAbsLength() const
    {
        return fArAbsLength;
    }

    G4double GetLightGuideRadius() const
    {
        return fLightGuideRadius;
    }

    G4double GetLightGuideLength() const
    {
...
inline const G4LogicalVolume *CDEXDetectorConstruction::GetArgonVolume(G4String mode) const
{
    ...
    else if (mode == "CDEX300LF")
    {
        return logicArVolume;
    }
    else if (mode == "CDEX300LG")
    {
        return logicArVolume;
    }
    else
