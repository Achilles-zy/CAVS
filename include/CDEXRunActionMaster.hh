...
#ifndef CDEXRunActionMaster_h
#define CDEXRunActionMaster_h
...
class CDEXRunMasterMessenger;

class CDEXRunActionMaster : public G4UserRunAction
{
public:
	CDEXRunActionMaster(CDEXPrimaryGeneratorAction *, CDEXDetectorConstruction *);
	~CDEXRunActionMaster();
...
private:
	...
	CDEXRunMasterMessenger *fRunMasterMessenger;
	G4String filename;
	G4String txtname;
	G4int runID;
	G4bool ifRefresh;
