...
G4VPhysicalVolume *CDEXDetectorConstruction::Construct()
{
	...
	else if (fMode == "CDEX300LG")
	{
		return ConstructCDEX300System_LG();
	}
	else if (fMode == "CDEX300LF")
	{
		return ConstructCDEX300System_LF();
	}
	...
	{
		G4cout << "Error: Mode not found!" << G4endl;
	}
}
...
G4VPhysicalVolume *CDEXDetectorConstruction::ConstructCDEX300System_LG()
{
G4NistManager *nist = G4NistManager::Instance();
	G4bool checkOverlaps = true;
	G4double SmallestUnitHeight = fSmallestUnitHeight;
...
G4VPhysicalVolume *CDEXDetectorConstruction::ConstructCDEX300System_LF()
{
	G4NistManager *nist = G4NistManager::Instance();
	G4bool checkOverlaps = true;
	G4double SmallestUnitHeight = fSmallestUnitHeight;
